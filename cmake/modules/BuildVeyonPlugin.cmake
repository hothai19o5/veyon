# BuildVeyonPlugin.cmake - Copyright (c) 2017-2026 Tobias Junghans
#
...
function(build_veyon_plugin TARGET)
	...
	if(NOT WIN32 AND NOT WITH_TESTS)
		set_target_properties(${TARGET} PROPERTIES LIBRARY_OUTPUT_DIRECTORY "${CMAKE_BINARY_DIR}/${VEYON_INSTALL_PLUGIN_DIR}")
	endif()
