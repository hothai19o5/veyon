...
void ComputerZoomWidget::updateComputerZoomWidgetTitle()
{
	...
	if (username.isEmpty())
	{
		setWindowTitle(QStringLiteral("%1 - EduMonitor").arg(m_vncView->computerControlInterface()->computerName()));
	}
	else
	{
		setWindowTitle(QStringLiteral( "%1 - %2 - EduMonitor").arg(username,
